...
public:
    ...
    static constexpr std::uint32_t MAX_1D_WORKGROUP_THREADS{1024};
    static constexpr std::uint32_t MAX_2D_WORKGROUP_THREADS{32};
    static constexpr std::uint32_t MAX_3D_WORKGROUP_THREADS{8};
